...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/falling-mountain-dd3e-abj
```

A live public deployment of this template is available at [https://falling-mountain-dd3e-abj.templates.workers.dev](https://falling-mountain-dd3e-abj.templates.workers.dev)
